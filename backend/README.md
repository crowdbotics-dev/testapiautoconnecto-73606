...
## Project Structure
    ...
    ├── testapiautoconnecto_73606  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnecto_73606`
...
2. Clone this repo and `cd testapiautoconnecto_73606`
